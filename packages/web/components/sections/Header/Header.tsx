...
const Header = () => {
  return (
    <header className="px-2 pt-2 pb-2 flex flex-col gap-4 relative bg-gradient-to-t from-[#fff0] via-[#d8f4f845] to-[#F6FEFE] select-none">
      ...
      {/* <Row
        align="center"
        className="bg-[#f2f4f765] border-[2px] rounded-3xl px-4 h-12 w-full gap-4"
      >
        <FontAwesomeIcon
